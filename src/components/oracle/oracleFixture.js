...
export const CANDIDATE_ACTIONS = [
  {
    ...
    missionLossRate: 0.04,
    stdFinalBatterySoc: 0.041,
    nominalRecoveryRate: 0.86,
    degradedRate: 0.10,
    missionLossCount: 4,
    nominalCount: 86,
    degradedCount: 10,
  ...
  {
    actionName: 'shed_nonessential_load',
    safetyScore: 0.792,
    successProbability: 0.78,
    missionLossRate: 0.07,
    stdFinalBatterySoc: 0.055,
    nominalRecoveryRate: 0.78,
    degradedRate: 0.15,
    missionLossCount: 7,
    nominalCount: 78,
    degradedCount: 15,
  ...
  {
    actionName: 'reorient_max_solar_exposure',
    safetyScore: 0.651,
    successProbability: 0.64,
    missionLossRate: 0.12,
    stdFinalBatterySoc: 0.072,
    nominalRecoveryRate: 0.64,
    degradedRate: 0.24,
    missionLossCount: 12,
    nominalCount: 64,
    degradedCount: 24,
  ...
  {
    actionName: 'activate_backup_heater',
    safetyScore: 0.441,
    successProbability: 0.43,
    missionLossRate: 0.14,
    stdFinalBatterySoc: 0.091,
    nominalRecoveryRate: 0.43,
    degradedRate: 0.43,
    missionLossCount: 14,
    nominalCount: 43,
    degradedCount: 43,
  ...
  {
    actionName: 'enter_safe_low_power_mode',
    safetyScore: 0.297,
    successProbability: 0.28,
    missionLossRate: 0.32,
    stdFinalBatterySoc: 0.118,
    nominalRecoveryRate: 0.28,
    degradedRate: 0.40,
    missionLossCount: 32,
    nominalCount: 28,
    degradedCount: 40,
  ...
  {
    actionName: 'thruster_isolation',
    safetyScore: 0.118,
    successProbability: 0.11,
    missionLossRate: 0.51,
    stdFinalBatterySoc: 0.195,
    nominalRecoveryRate: 0.11,
    degradedRate: 0.38,
    missionLossCount: 51,
    nominalCount: 11,
    degradedCount: 38,
