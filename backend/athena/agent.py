...
class AthenaAgent:
    ...
    Args:
        api_key:     OpenRouter API key. If None, reads OPENROUTER_API_KEY env
                     var (falls back to GEMINI_API_KEY, but that only works if
                     it's also a valid OpenRouter key).
